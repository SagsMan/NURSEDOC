...
<!-- Mirrored from bracketweb.com/careold-html/services-carousel.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Sep 2026 21:34:37 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>NurseDoc Connect Services | Healthcare across Nigeria</title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png" />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
        <meta name="description" content="Explore NurseDoc Connect home care, nursing care, medical care, disability support, companion care and personalized care across Nigeria." />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__shape -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-right">Services Carousel</h2>
        ...
        <section class="service-two service-two--page">
            <div class="service-two__bg" style="background-image: url(assets/images/shapes/service-bg-2.jpg);"></div>
            <div class="container">
                <div class="service-two--page__carousel careold-owl__carousel careold-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
				"items": 1,
				"margin": 30,
				"loop": false,
				"smartSpeed": 700,
				...
				"responsive": {
                    ...
                    <div class="item">
                        <div class="service-two__item wow fadeInUp" data-wow-delay="00ms">
                            <div class="service-two__item__shape" style="background-image: url(assets/images/shapes/service-2-shape.png);"></div>
                            <div class="service-two__item__image">
                                <img src="assets/images/resources/service-2-1.jpg" alt="careold">
                            </div>
                            <div class="service-two__item__number">Service</div><!-- /.service-two__item__number -->
                            <h3 class="service-two__item__title">
                                <a href="service-d-companion.php">Companion Care</a>
                            </h3><!-- /.service-title -->
                            <p class="service-two__item__text">
                                    Practical healthcare support for patients and families across Nigeria.
                            </p>
                            <a href="service-d-companion.php" class="service-two__item__link">
                                Learn More
                                <span class="service-two__item__link__icon"><i class="icon-right-arrow"></i></span>
                            </a>
                    ...
                    <div class="item">
                        <div class="service-two__item wow fadeInUp" data-wow-delay="100ms">
                            <div class="service-two__item__shape" style="background-image: url(assets/images/shapes/service-2-shape.png);"></div>
                            <div class="service-two__item__image">
                                <img src="assets/images/resources/service-2-2.jpg" alt="careold">
                            </div>
                            <div class="service-two__item__number">Service</div><!-- /.service-two__item__number -->
                            <h3 class="service-two__item__title">
                    ...
                    <div class="item">
                        <div class="service-two__item wow fadeInUp" data-wow-delay="200ms">
                            <div class="service-two__item__shape" style="background-image: url(assets/images/shapes/service-2-shape.png);"></div>
                            <div class="service-two__item__image">
                                <img src="assets/images/resources/service-2-3.jpg" alt="careold">
                            </div>
                            <div class="service-two__item__number">Service</div><!-- /.service-two__item__number -->
                            <h3 class="service-two__item__title">
                    ...
                    <div class="item">
                        <div class="service-two__item wow fadeInUp" data-wow-delay="300ms">
                            <div class="service-two__item__shape" style="background-image: url(assets/images/shapes/service-2-shape.png);"></div>
                            <div class="service-two__item__image">
                                <img src="assets/images/resources/service-2-4.jpg" alt="careold">
                            </div>
                            <div class="service-two__item__number">Service</div><!-- /.service-two__item__number -->
                            <h3 class="service-two__item__title">
                    ...
                    <div class="item">
                        <div class="service-two__item wow fadeInUp" data-wow-delay="400ms">
                            <div class="service-two__item__shape" style="background-image: url(assets/images/shapes/service-2-shape.png);"></div>
                            <div class="service-two__item__image">
                                <img src="assets/images/resources/service-2-5.jpg" alt="careold">
                            </div>
                            <div class="service-two__item__number">Service</div><!-- /.service-two__item__number -->
                            <h3 class="service-two__item__title">
                    ...
                    <div class="item">
                        <div class="service-two__item wow fadeInUp" data-wow-delay="500ms">
                            <div class="service-two__item__shape" style="background-image: url(assets/images/shapes/service-2-shape.png);"></div>
                            <div class="service-two__item__image">
                                <img src="assets/images/resources/service-2-6.jpg" alt="careold">
                            </div>
                            <div class="service-two__item__number">Service</div><!-- /.service-two__item__number -->
                            <h3 class="service-two__item__title">
