...
<!-- Mirrored from bracketweb.com/careold-html/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Sep 2026 21:34:36 GMT -->
<head>
    <meta charset="UTF-8" />
        ...
        <section class="login-page">
            <div class="container">
                <div class="login-page__info">
                    <p>We have a demo account setup. <span>Username:</span> <a href="login.php">demo</a> and <span>
                            Password:</span> <a href="login.php">demo</a></p>
                </div><!-- login-info -->
                <div class="row">
                        ...
                        <div class="login-page__wrap">
                            ...
                            <form class="login-page__form">
                                ...
                                <div class="login-page__form-btn-box">
                                    <button type="submit" class="careold-btn"><i>Login</i><span>Login</span></button>
                                    <div class="login-page__form-forgot-password">
                                        <a href="login.php">Forgot your Passowrd?</a>
                                    </div>
                                </div>
                            </form>
                        </div><!-- login-form -->
                    ...
                    <div class="col-lg-6 wow fadeInUp animated" data-wow-delay="400ms">
                        <div class="login-page__wrap">
                            ...
                            <form class="login-page__form">
                                ...
                                <div class="login-page__form-btn-box">
                                    <button type="submit" class="careold-btn">
                                        <i>Register</i>
                                        <span>Register</span>
                                    </button>
                                </div>
