...
<!-- Mirrored from bracketweb.com/careold-html/gallery-filter.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Sep 2026 21:34:33 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Care in practice | NurseDoc Connect Nigeria</title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png" />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
        <meta name="description" content="See how NurseDoc Connect helps families arrange healthcare and support across Nigeria." />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__shape -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-right">Gallery Filter</h2>
            ...
            <div class="container">
                <div class="text-center">
                    <ul class="list-unstyled post-filter gallery-one__filter__list">
                        ...
                        <li data-filter=".healthy"><span>Healthy</span></li>
                        <li data-filter=".wellness"><span>Wellness</span></li>
                        <li data-filter=".nursing"><span>Nursing</span></li>
                        <li data-filter=".medical"><span>Medical</span></li>
                    </ul><!-- /.list-unstyledf -->
                </div><!-- /.text-center -->
                <div class="row filter-layout fitRow-layout">
                    <div class="col-md-6 col-lg-6 filter-item healthy">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-1.jpg" alt="careold">
                    ...
                    <div class="col-md-6 col-lg-6 filter-item wellness">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-2.jpg" alt="careold">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item nursing">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-3.jpg" alt="careold">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item medical">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-4.jpg" alt="careold">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item healthy">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-5.jpg" alt="careold">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item wellness">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-6.jpg" alt="careold">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item nursing">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-7.jpg" alt="careold">
                            <div class="gallery-one__card__hover">
                    ...
                    <div class="col-md-6 col-lg-4 filter-item medical">
                        <div class="gallery-one__card">
                            <img src="assets/images/gallery/gallery-1-8.jpg" alt="careold">
                            <div class="gallery-one__card__hover">
